...
class tbNominas extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_tbnominas';
	var $table_index= 'tbnominasid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_tbnominascf', 'tbnominasid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_tbnominas', 'vtiger_tbnominascf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_tbnominas' => 'tbnominasid',
		'vtiger_tbnominascf'=>'tbnominasid');
	...
	var $list_fields = Array (
	    ...
	    'LBL_TBNOMINAS_DESCRIPCION' => Array('tbnominas', 'descripcion_tbnomina'),
	    'LBL_TBNOMINAS_FECHAINICIO' => Array('tbnominas', 'fechainicio_tbnomina'),
	    'LBL_TBNOMINAS_PDF' => Array('tbnominas', 'pdf_tbnomina'),	    	  
		'Assigned To' => Array('crmentity','smownerid')
	);
	var $list_fields_name = Array (
	    /* Format: Field Label => fieldname */
	    'LBL_TBNOMINAS_DESCRIPCION' => 'descripcion_tbnomina',
	    'LBL_TBNOMINAS_FECHAINICIO' => 'fechainicio_tbnomina',
	    'LBL_TBNOMINAS_PDF' => 'pdf_tbnomina',
	    ...
	    if ($_FILES) {
	        ...
	        foreach ($_FILES as $fileindex => $files) {
	            if ($files['name'] != '' && $files['size'] > 0) {
	                ...
	                {
	                    $v_query = "UPDATE vtiger_tbnominas SET $fileindex = ? WHERE tbnominasid = ?";
