...
class tbContratos extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_tbcontratos';
	var $table_index= 'tbcontratosid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_tbcontratoscf', 'tbcontratosid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_tbcontratos', 'vtiger_tbcontratoscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_tbcontratos' => 'tbcontratosid',
		'vtiger_tbcontratoscf'=>'tbcontratosid');
	...
	var $list_fields = Array (
	    ...
	    'LBL_TBCONTRATOS_EMPLOYEE' => Array('tbcontratos', 'employee_tbcontrato'),
	    'LBL_TBCONTRATOS_FECHAINICIO' => Array('tbcontratos', 'fechainicio_tbcontratos'),
	    'LBL_TBCONTRATOS_FECHAFIN' => Array('tbcontratos', 'fechafin_tbcontratos'),
	    'LBL_TBCONTRATOS_SUELDOANUAL' => Array('tbcontratos', 'sueldoanual_tbcontratos'),
	    'LBL_TBCONTRATOS_SUELDOMENSUAL' => Array('tbcontratos', 'sueldomensual_tbcontratos'),
		'Assigned To' => Array('crmentity','smownerid')
	);
	var $list_fields_name = Array (
	    /* Format: Field Label => fieldname */
	    'LBL_TBCONTRATOS_EMPLOYEE' => 'employee_tbcontrato',
	    'LBL_TBCONTRATOS_FECHAINICIO' => 'fechainicio_tbcontratos',
	    'LBL_TBCONTRATOS_FECHAFIN' => 'fechafin_tbcontratos',
	    'LBL_TBCONTRATOS_SUELDOANUAL' => 'sueldoanual_tbcontratos',
	    'LBL_TBCONTRATOS_SUELDOMENSUAL' => 'sueldomensual_tbcontratos',
		'Assigned To' => 'assigned_user_id',
	);

	// Make the field link to detail view
	var $list_link_field = 'tbcontratosno';
	...
	var $popup_fields = Array ('tbcontratosno');

	// For Alphabetical search
	var $def_basicsearch_col = 'tbcontratosno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'tbcontratosno';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('tbcontratosno','assigned_user_id');

	var $default_order_by = 'tbcontratosnos';
	    ...
	    if ($_FILES) {
	        ...
	        foreach ($_FILES as $fileindex => $files) {
	            if ($files['name'] != '' && $files['size'] > 0) {
	                ...
	                {
	                    $v_query = "UPDATE vtiger_tbcontratos SET $fileindex = ? WHERE tbcontratosid = ?";
